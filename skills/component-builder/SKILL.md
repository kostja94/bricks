...
description: Build, adapt, or substantially improve interface components in an existing project. Use for named components and interface blocks such as footers, heroes, navigation, cards, forms, content sections, and agent workspaces. Preserve the target project's design system and stack; do not use for full-page information architecture or purely editorial copy requests.
metadata:
  version: 0.1.0
---
...
Create components that belong in the target product instead of producing isolated demo UI.
...
- whether this is a new component, adaptation, or reconstruction;
- the component's real content and states;
- the target stack and existing ownership boundary.

## Load Only Relevant Guidance

Read [references/workflow.md](references/workflow.md) for construction or reconstruction work and [references/quality-gates.md](references/quality-gates.md) before final verification.
...
- Prefer adapting an existing project component over creating a parallel replacement.
